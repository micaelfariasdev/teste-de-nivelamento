...
LOAD DATA INFILE  'dados/demonstracoes/2023/1T2023.csv'
...
LOAD DATA INFILE  'dados/demonstracoes/2023/2T2023.csv'
INTO TABLE temp_demonstracoes
FIELDS TERMINATED BY ';'
ENCLOSED BY '"'
LINES TERMINATED BY '\n'
...
LOAD DATA INFILE  'dados/demonstracoes/2023/3T2023.csv'
INTO TABLE temp_demonstracoes
FIELDS TERMINATED BY ';'
ENCLOSED BY '"'
LINES TERMINATED BY '\n'
...
LOAD DATA INFILE  'dados/demonstracoes/2023/4T2023.csv'
INTO TABLE temp_demonstracoes
FIELDS TERMINATED BY ';'
ENCLOSED BY '"'
LINES TERMINATED BY '\n'
...
LOAD DATA INFILE  'dados/demonstracoes/2024/1T2024.csv'
INTO TABLE temp_demonstracoes
FIELDS TERMINATED BY ';'
ENCLOSED BY '"'
LINES TERMINATED BY '\n'
...
LOAD DATA INFILE  'dados/demonstracoes/2024/2T2024.csv'
INTO TABLE temp_demonstracoes
FIELDS TERMINATED BY ';'
ENCLOSED BY '"'
LINES TERMINATED BY '\n'
...
LOAD DATA INFILE  'dados/demonstracoes/2024/3T2024.csv'
INTO TABLE temp_demonstracoes
FIELDS TERMINATED BY ';'
ENCLOSED BY '"'
LINES TERMINATED BY '\n'
...
LOAD DATA INFILE  'dados/demonstracoes/2024/4T2024.csv'
INTO TABLE temp_demonstracoes
FIELDS TERMINATED BY ';'
ENCLOSED BY '"'
LINES TERMINATED BY '\n'
...
INSERT INTO c (data_reg, REG_ANS, CD_CONTA_CONTABIL, DESCRICAO, VL_SALDO_INICIAL, VL_SALDO_FINAL)
SELECT data_reg, REG_ANS, CD_CONTA_CONTABIL, DESCRICAO, VL_SALDO_INICIAL, VL_SALDO_FINAL
FROM temp_demonstracoes
WHERE CHAR_LENGTH(CD_CONTA_CONTABIL) = 9;
drop table temp_demonstracoes;
